...
//        setImageToWrapCropBounds(false);
    ...
    public void flipHorizontal(){
        flipHorizontal(mCropRect.centerX(), mCropRect.centerY());
    }
    ...
    public void flipVertical(){
        flipVertical(mCropRect.centerX(), mCropRect.centerY());
    }
...
//        setImageToWrapCropBounds(true);
    ...
    protected boolean isImageWrapCropBounds(float[] imageCorners) {
        ...
        return false/*RectUtils.trapToRect(unrotatedImageCorners).contains(RectUtils.trapToRect(unrotatedCropBoundsCorners))*/;
    }
