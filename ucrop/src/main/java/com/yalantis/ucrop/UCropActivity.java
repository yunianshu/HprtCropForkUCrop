...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.save_crop).setOnClickListener(v -> {
            cropAndSaveImage();
        });
    }
...
//        menu.findItem(R.id.menu_loader).setVisible(mShowLoader);
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, R.color.base_color));
        ...
        mToolbarCancelDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.ic_btn_back_dark);
        ...
        mLogoColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_LOGO_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_crop_background));
...
//        }
        ImmersionBar.with(this)
                .statusBarColor(R.color.ucrop_color_white)
...
//                resetRotation();
    ...
    private void setHorizontalFlip() {
        mGestureCropImageView.flipHorizontal();
    }

    /**
     * 设置垂直镜像
     */
    private void setVerticalFlip() {
        mGestureCropImageView.flipVertical();
    }
...
//            }
            setHprtWidgetState(R.id.state_aspect_ratio);
        } else {
    ...
    private void setHprtWidgetState(@IdRes int stateViewId) {
        if (!mShowBottomControls) {
            return;
        }

        mWrapperStateAspectRatio.setSelected(false);
        ...
        mWrapperStateScale.findViewById(R.id.text_view_scale).setVisibility(View.GONE);
        mWrapperStateAspectRatio.findViewById(R.id.text_view_crop).setVisibility(View.GONE);
        mWrapperStateRotate.findViewById(R.id.text_view_rotate).setVisibility(View.VISIBLE);
